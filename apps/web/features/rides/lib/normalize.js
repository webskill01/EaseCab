...
export function toBotVM(r) {
  return {
    ...
    fromLocalized: { pa: r.pickupCityNamePa ?? null, hi: r.pickupCityNameHi ?? null },
    toLocalized: { pa: r.dropCityNamePa ?? null, hi: r.dropCityNameHi ?? null },
...
export function toVerifiedVM(p) {
  return {
    ...
    posterPhotoUrl: p.posterPhotoUrl ?? null,
    posterExperience: p.posterExperience ?? null,
    posterAadhaarVerified: p.posterAadhaarVerified ?? false,
    verifiedDriver: p.verifiedDriver ?? false,
    from: cityLabel(p.fromCityName, p.fromCityRaw),
    to: cityLabel(p.toCityName, p.toCityRaw),
    fromLocalized: { pa: p.fromCityNamePa ?? null, hi: p.fromCityNameHi ?? null },
    toLocalized: { pa: p.toCityNamePa ?? null, hi: p.toCityNameHi ?? null },
    vehicleType: p.vehicleType ?? null,
