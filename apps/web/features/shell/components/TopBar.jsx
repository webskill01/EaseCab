...
/**
 * App chrome (chrome.jsx TopBar): steering-wheel brand · Chats · language pill ·
...
export function TopBar({ locale }) {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center gap-2 border-b border-ec-line bg-white px-3.5 py-2.5">
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[10px] bg-ec-blue text-white">
        <Steer size={22} />
      </div>
