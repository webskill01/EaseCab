...
export function VerificationTimeline({ profile }) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-y-auto bg-ec-bg p-3.5 pb-6">
      {/* summary */}
            ...
            <div key={s.key}>
              ...
              <div className="flex gap-3.5">
                ...
                <div className="min-w-0 flex-1 pb-3.5">
                  <div className={`rounded-2xl border bg-white p-3.5 shadow-ec-card ${s.done ? 'border-ec-success/30' : 'border-ec-line'}`}>
                    ...
                    {s.done ? (
                      ...
                      <>
                        {s.hint && <p className="mt-1.5 text-[12.5px] font-medium leading-snug text-ec-ink60">{s.hint}</p>}
