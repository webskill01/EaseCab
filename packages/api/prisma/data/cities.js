...
//      pgi/pgimer/pkl (hospital aliases) are added to Chandigarh per legacy intent.
...
const CITIES = [
  ...
  { canonicalName: 'Manali', state: 'Himachal Pradesh', district: 'Kullu', type: 'town', lat: 32.2396, lng: 77.1887, aliases: ['manali', 'manaali', 'manalli', 'manal', 'manali airport', 'bhuntar airport', 'kullu manali', 'rohtang', 'rohtang pass', 'rohtang la', 'rothang', 'solang', 'solang valley', 'solang nala', 'sollang', 'old manali', 'mall road manali', 'vashisht', 'vashisth', 'vasisth', 'naggar', 'nagar', 'naggr', 'naggar castle'] },
